export const features = [
  {
    ...
    caption: "Simplified Healthcare Management",
    title: "Care Smarter, Run Better",
    text: "With MediTrack, healthcare operations are streamlined. Schedule appointments, manage patients, and handle records—effortlessly from a single, intuitive platform.",
    button: {
  ...
  },
  {
    ...
    caption: "Secure & Compliant",
    title: "Your Patients—Protected",
    text: "MediTrack uses enterprise-grade security and privacy features to ensure all patient data is securely stored, compliant, and accessible only to authorized staff.",
    button: {
...
export const details = [
  {
    ...
    title: "Effortless Patient Registration & Management",
  },
  {
    id: "1",
    icon: "/images/detail-2.png",
    title: "Flexible Appointment Scheduling & Notifications",
  },
  {
    id: "2",
    icon: "/images/detail-3.png",
    title: "Secure File Upload & Cloud Storage (Appwrite)",
  },
  {
    id: "3",
    icon: "/images/detail-4.png",
    title: "Real-Time Monitoring with Sentry Integration",
  },
];
...
export const faq = [
  {
    id: "0",
    question: "How easy is it to set up MediTrack?",
    answer:
      "Setting up MediTrack is simple and user-friendly. Just sign up, create your practice profile, and start managing patient appointments, records, and more!",
  },
  {
    id: "1",
    question: "Can I integrate MediTrack with other healthcare systems?",
    answer:
      "Currently, MediTrack does not support third-party integrations. However, we are continuously exploring new integration opportunities to improve your practice management experience.",
  },
  {
    id: "2",
    question: "How often do you update the platform?",
    answer:
      "We regularly update MediTrack to improve performance and add new features, ensuring that you have access to the latest advancements in healthcare technology.",
  },
  {
    id: "3",
    question: "What is your refund policy?",
    answer:
      "We offer a free trial for healthcare providers to test MediTrack before committing. If you're not satisfied, you can cancel anytime with no hassle.",
  },
  {
    id: "4",
    question: "Do you have plans for different practice sizes?",
    answer:
      "Yes! MediTrack offers flexible plans to suit solo practitioners, small clinics, and larger healthcare facilities, with a variety of features tailored to each need.",
  },
  {
    id: "5",
    question: "What happens when I run out of storage?",
    answer:
      "MediTrack uses Appwrite storage, and if you run out of space, you can upgrade your plan to access more storage for patient files and other documents.",
  },
  {
    id: "6",
    question: "Can I upgrade my plan later?",
    answer:
      "Yes! You can upgrade your plan at any time, and the changes will take effect immediately with a prorated discount.",
  },
  {
    id: "7",
    question: "How do I invite staff members to the platform?",
    answer:
      "You can easily invite staff members by sending them a secure registration link or generating a QR code for them to scan and sign up.",
  },
  {
    id: "8",
    question: "Do you offer training for practice admins?",
    answer:
      "Yes! MediTrack provides comprehensive tutorials and live support to help practice admins efficiently manage the platform.",
  },
  {
    id: "9",
    question: "I’m locked out of my account. What should I do?",
    answer:
      "If you're locked out, you can use the 'Forgot Password' feature to reset your login credentials. If you need further assistance, our support team is available to help.",
  },
  {
    id: "10",
    question: "How does MediTrack handle appointments?",
    answer:
      "Patients can easily book appointments with doctors, and administrators can confirm or schedule these appointments from the admin dashboard. Patients receive SMS notifications on appointment confirmations.",
  },
  {
    id: "11",
    question: "Can I upload patient files in MediTrack?",
    answer:
      "Yes, MediTrack allows you to upload and securely store patient files using Appwrite storage, ensuring that all documents are safe and accessible.",
  },
  {
    id: "12",
    question: "Is MediTrack fully responsive?",
    answer:
      "Yes! MediTrack is designed to work seamlessly across all devices and screen sizes, ensuring a smooth experience whether you’re using a mobile, tablet, or desktop.",
  },
  {
    id: "13",
    question: "Does MediTrack track and monitor performance?",
    answer:
      "Yes! MediTrack integrates with Sentry to monitor and track the application’s performance, helping us detect and fix any errors quickly.",
  },
];
...
export const plans = [
  {
    ...
    priceMonthly: 599,
    priceYearly: 5499,
    caption: "For small solo practices or clinics",
    features: [
      "1-2 admin users",
      "Patient booking system",
      "SMS notifications (limited to 200 per month)",
      "Admin dashboard",
      "Onboarding documentation",
      "Basic file storage (Appwrite)",
      "Sentry monitoring (limited logs)",
    ],
  ...
  },
  {
    ...
    priceMonthly: 999,
    priceYearly: 9599,
    caption: "For growing practices with multiple doctors",
    features: [
      "Everything in Starter, plus:",
      "Unlimited patient accounts",
      "5 admin users",
      "SMS notifications (higher limit)",
      "File uploads with more storage",
      "Priority support",
      "Advanced appointment handling features",
    ],
  ...
  },
  {
    ...
    priceMonthly: 1499,
    priceYearly: 14299,
    caption: "For larger practices or private clinics",
    features: [
      "Everything in Starter, plus:",
      "Custom branding",
      "Unlimited SMS & file uploads",
      "Custom integration support",
      "In-person training or remote onboarding",
...
export const testimonials = [
  {
    ...
    comment:
      "MediTrack has been a game-changer for our practice. The ease of scheduling and managing patient data has improved our efficiency tremendously!",
  },
  {
    id: "1",
    name: "Dr. Emily Jones",
    ...
    comment:
      "At first, I wasn’t sure about switching to a new platform, but MediTrack has exceeded our expectations. It’s user-friendly and reliable.",
  },
  {
    id: "2",
    name: "Nina Adams",
    ...
    comment:
      "The secure file storage and real-time monitoring features make MediTrack a must-have for any modern healthcare practice.",
  },
  {
    id: "3",
    name: "Dr. Samuel Gray",
    ...
    comment:
      "The cloud-based system makes it easy to access patient records anytime, anywhere. MediTrack has improved our practice's workflow significantly.",
  },
  {
    id: "4",
    name: "Dr. Jim Flores",
    ...
    comment:
      "We switched to MediTrack recently, and the difference has been remarkable. Our patients are more satisfied, and our team is more efficient.",
  },
  {
    id: "5",
    name: "Melanie Carter",
    ...
    comment:
      "The integrated features and seamless setup process make MediTrack an indispensable tool for managing our entire center. Highly recommend it!",
  },
];
